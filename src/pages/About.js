            ...
            <div className="about section">
                ...
                <div className="about-me">
                    ...
                    <p>Si je devais qualifier mon parcours en un mot, je dirais atypique.
                        ...
                        J'ai donc suivi une formation pour acquérir des connaissances solides. <br></br> <br></br> Autodidacte, je continue d'élargir mes compétences, même si je me suis spécialisé en <span class="important-words">Javascript. </span>
                        Les technologies  principales que j’utilise sont <span class="important-words">Vuejs</span> et <span class="important-words">React côté frontend, Nodejs/Express en backend</span> et <span class="important-words">Symfony/PHP récemment (projet Speedype). </span>
